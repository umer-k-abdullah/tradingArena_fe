...
const Oponent = () => {
  ...
  const [stats, setStats] = useState([
    { icon: "/assets/icons/win-streak.png", label: "Skill Score", value: 0, inc_dec: "+0%" },
    { icon: "/assets/icons/win-rate.png", label: "Battle Win Rate", value: 0, inc_dec: "+0%" },
    { icon: "/assets/icons/stats.png", label: "Total Profit", value: 0, inc_dec: "+0%" },
  ]);

  const usernames = Array.from({ length: 100 }, (_, i) => `User${i + 1}`);
  const avatars = ["/assets/images/avatar1.png", "/assets/images/avatar2.png", "/assets/images/avatar3.png"]; // Add more avatar paths as needed
  ...
  return (
    <div className="font-poppins flex flex-col justify-center items-center gap-5">
      <div className="w-[200px] max-h-[200px] animate-scroll rounded-full border-2">
        <img
